...
class Paginator(object):
    ...
    ..usage::
        ...
        :Example1:
        from greenovative.greenergy.paginator import Paginator
    ...
    def page(self, page_number):
        ...
        ..warning::
            ...
            - EmptyPage
        """
        if(page_number == 1 and self.per_page_limit == 0):
            return Page(self.query_set.all(), page_number, self)
        else:
            page_number = self.validate_page_number(page_number)
            offset = (page_number - 1) * self.per_page_limit
        return Page(self.query_set.offset(offset).limit(self.per_page_limit).all(), page_number, self)
